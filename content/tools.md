...
**16-bit art rig** -- a Raspberry Pi driving a small display, running
generative pixel art nobody asked for. Started as a joke, still running.

**quant/finance scripts** -- side tools for pulling and charting market
data. Not trading anything real with them, just like watching numbers
move.
